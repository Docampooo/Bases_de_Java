...
public class Principal{
        ...
        do {
            ...
            switch (opcion) {
                ...
                case 6:
                    ...
                    break;
                case 7:
                    System.out.println(emp.d.firmaMail());
                    break;
                case 8:
                    System.out.println("has salido");
                    break;
    ...
    public static void main(String[] args) {
        ...
        Directivo d = new Directivo("Nicolas", "Docampo", 18, "54380687q", "Reposteria", 63000);
        Empleado e1 = new Empleado("Alberto", "Carril", 24, "55001505h", 22000);
        Empleado e2 = new Empleado("Pablo", "Vaz", 20, "83256973d", 28000);
