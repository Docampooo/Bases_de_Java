public class Bol5_Ejer4 {
    ...
    /**
     * Se le pasa un String y devuelve cada uno de sus caracteres en una línea diferente
    ...
    public static String subCadena(String cadena, int posicion, int caracteres){
        ...
        String resultado ="";
        //cadena null
        if( cadena == null ||cadena.equals("") || (posicion < 0 || posicion >= cadena.length() ) || (caracteres < 0 || caracteres + posicion >= cadena.length() )){
            return "";
        } else{
    ...
    /**
     * se le pasa una cadena y devuelve un vector char donde cada caracter de la cadena es un elemento del vector
    ...
    public static void main(String[] args) {
        ...
        //     "El Nicolas", "Pablo_Vaz", "Alberto Carril", "Lucas Gonzalez"
        // };
        
        muestraEnLinea("Alberto y el trujo");

        System.out.println(subCadena("AlbertoCarril", 5, 3));

        muestraCentrado("Alberto Carril");
        ...
        System.out.println(pasoAMayusculas( "El Nicolas", "Pablo_Vaz", "Alberto Carril", "Lucas Gonzalez", "ABC abc_1234_!$(){}][]ñÑ"));
